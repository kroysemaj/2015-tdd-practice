// Write a function that takes a number n and returns it's prime factors.
...
describe('Prime Factors', function(){
  ...
  it('should return [3, 3] when passed 9', function() {
    expect(primes(9)).toEqual([3, 3])
  });

  it('should factor a truly ridiculous number', function() {
    expect(primes(6883547)).toEqual([11, 625777])
  });
});
